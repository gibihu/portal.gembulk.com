...
//            dd($request->all());
            $real_cost = $cost * $receiver_count;
            if($user->credits >= $real_cost){

                $all_status = DB::transaction(function () use ($user, $cp_name, $receivers, $sender_id, $server_id, $cost, $real_cost, $msg, $receiver_count, $is_scheduled, $scheduled_at) {
